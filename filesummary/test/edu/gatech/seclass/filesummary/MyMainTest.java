...
public class MyMainTest {
    ...
    */
    ...
    public void fileSummaryTest26() throws Exception {
        File inputFile24 = createInputFile(FILE4);

        String args[] = { "-r", "!@", "-s", "2ipt esUhw", "-a", "4", inputFile24.getPath()};
        Main.main(args);

        String expected24 = "Down1_and_Down2 with the red and black!!\rUp1_and_Up2 with the white and gold!";
